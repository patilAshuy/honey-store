      ...
      <body className={`${inter.variable} ${outfit.variable} font-inter antialiased`}>
        <CartProvider>
          ...
          <a 
            ...
            className="fixed bottom-8 right-8 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all z-50 animate-bounce flex items-center justify-center"
